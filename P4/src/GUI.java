...
public class GUI extends JPanel 
{
   ...
   /**
    ...
    private void buildSliders()
    {
        ...
        JSlider lSlider = new JSlider( JSlider.VERTICAL, 0, 100, 100 );
        addLabels( lSlider, 10 );
        lSlider.addChangeListener( new SliderListener( lSlider, "LightColor" ));
    ...
    public class SliderListener implements ChangeListener
    {
        ...
        public void stateChanged( ChangeEvent ev )
        {
            if ( _id.equals( "y" ))       // y-slider
            {
                ...
                Color lColor = SceneManager.getLightColor();
                float[] comps = lColor.getColorComponents( null );
                comps[ 0 ] = ((float) _slider.getValue()) / 500.0f;
                SceneManager.setLightColor( 
                    new Color( comps[0], comps[1], comps[2] ));
            }
            else if ( _id.equals( "x" ))  // x-slider
                System.out.println( "X: " + _slider.getValue() );
            else   // size slider
                System.out.println( "L: " + _slider.getValue() );
